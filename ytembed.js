...
var ytEmbed = {
    ...
    listVideos: function(json, cfg) {
        ...
        if (json.error) {
            ...
            ul.className = 'youtube-section-list center';
            ...
            for (var i = 0; i < json.items.length; i++) {
                ...
                if (this.cfg.layout == 'thumbnails') {
                    ...
                    //this.cfg.layout = full
                    li.innerHTML = '<div class="youtube-section-thumbnail" onClick="ga(\'send\', \'event\', \'Video\', \'Play\', \'Youtube\');"></div><div><h3>' + entry.snippet.title + '</h3></div>';
